...
<span style={{fontSize:"12px" ,color:"#474747" , fontWeight:600}}>{card.updatedAt.slice(0, 10)}</span>
            </p>
                              </div>
                {/* <h5 className="mb-1">
                  {card.phoneNumber || "Unknown Buyer"} |{" "}
                ...
                {card.phoneNumber || "Unknown Buyer"} |{" "}  <span className="text-muted" style={{ fontSize: "12px" }}>| Buyer</span>
          </h5>
            ...
            <div className="p-1">
              ...
              >
                ...
                <div className="d-flex align-items-center me-3">
                  ...
                  <p className="mb-0 "style={{fontSize:"12px", color:"#474747"}}>{card.noOfBHK} BHK</p>
                </div>
                <div className="d-flex align-items-center me-3">
