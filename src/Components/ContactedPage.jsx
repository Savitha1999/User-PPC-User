...
// import { FaEnvelope, FaGlobe, FaUser, FaPhone } from 'react-icons/fa';
...
// const ContactUsApp = () => {
//   const { id, phoneNumber } = useParams(); // Get contact ID & phone number from URL
//   const [formData, setFormData] = useState({
//     name: "",
//     email: "",
//     phoneNumber: phoneNumber || "", // Pre-fill but keep read-only
//     message: "",
//   });
...
//   // Fetch contact details when component loads
//   useEffect(() => {
//     if (id) {
//       fetchContactDetails();
//     }
...
//     try {
//       const response = await axios.get(`${process.env.REACT_APP_API_URL}/contactUs/${id}`);
//       if (response.data) {
//         setFormData({
//           name: response.data.name || "",
//           email: response.data.email || "",
//           phoneNumber: response.data.phoneNumber || "", // Read-only
...
//   // Handle input changes (except phone number)
...
//     try {
//       const url = id
//         ? `${process.env.REACT_APP_API_URL}/update-contactUs/${id}`
//         : `${process.env.REACT_APP_API_URL}/contactUs`;
      
//       const method = id ? "put" : "post"; // PUT for update, POST for new submission
      
//       const response = await axios[method](url, formData);

//       if (response.status === 200 || response.status === 201) {
//         setResponseMessage(id ? "Contact updated successfully!" : "Contact form submitted successfully!");
//         setError("");
//       }
//     } catch (error) {
...
//         <h4>{id ? "Update Contact" : "Quick Contact"}</h4>
//       </div>
...
//               readOnly={true}  // ✅ Keep phone number read-only
//               required 
//             />
//           </div>
//         </div>
